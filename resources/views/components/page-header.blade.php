...
<div class="flex flex-wrap items-start justify-between gap-5">
    <div class="flex min-w-0 items-start gap-4">
        ...
        <div><p class="mb-2 text-[10px] font-bold uppercase tracking-[.18em] text-emerald-700">{{ __('property.portfolio') }}</p><h1 class="page-title break-words">{{ $title }}</h1>@if($description)<p class="muted mt-2 max-w-2xl">{{ $description }}</p>@endif</div>
    </div>
